...
import sn.sntech.ediayma.config.audit.AuditEventConverter;
import sn.sntech.ediayma.domain.PersistentAuditEvent;
...
import static sn.sntech.ediayma.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
