...
import sn.sntech.ediayma.repository.CategorieRepository;
import sn.sntech.ediayma.service.CategorieService;
import sn.sntech.ediayma.service.dto.CategorieDTO;
import sn.sntech.ediayma.service.mapper.CategorieMapper;
...
public class CategorieResourceIT {
    ...
    public void createCategorie() throws Exception {
        ...
        assertThat(testCategorie.getFamille()).isEqualTo(DEFAULT_FAMILLE);
    }
    ...
    public void updateCategorie() throws Exception {
        ...
        assertThat(testCategorie.getFamille()).isEqualTo(UPDATED_FAMILLE);
    }
