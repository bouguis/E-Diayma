package sn.sntech.ediayma.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, sn.sntech.ediayma.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, sn.sntech.ediayma.repository.UserRepository.USERS_BY_EMAIL_CACHE);
